...
#ifndef _MMI_RP_APP_THREEDO_DEF_H
#define _MMI_RP_APP_THREEDO_DEF_H
...
typedef enum
{
    ...
    THREEDO_TIMER_FILE_UPLOAD_DELAY,
    THREEDO_TIMER_FILE_DOWNLOAD_DELAY,
    THREEDO_TIMER_ADORECD_LIMITE,
    MMI_RP_APP_THREEDO_TIMER_MAX
}mmi_rp_app_threedo_timer_enum;
...
typedef enum
{
    ...
    EVT_ID_THREEDO_SOCKET_EVENT_NOTIFY,
    MMI_RP_APP_THREEDO_EVENT_MAX
}mmi_rp_app_threedo_event_enum;
/******************** Events resource IDs - begin ********************/
...
typedef enum 
{
    ...
    MMI_RP_APP_THREEDO_VXML_LAYOUT_MAX
} mmi_rp_app_threedo_vxml_layout_enum;
/******************** Venus XML resource IDs - End ********************/



#endif /* _MMI_RP_APP_THREEDO_DEF_H */
